...
# (str) Package name
package.name = pocketbot

# (str) Package domain (needed for android/ios packaging)
package.domain = org.example.pocketbot
...
#       [app]
#       title = Pocket Bot # This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = Pocket Bot
#          package.name = pocketbot # This is all part of the title.
#
